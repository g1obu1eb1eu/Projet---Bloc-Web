...
<main class="login-content">
        ...
        <p class="register-link">
          Pas encore inscrit ? <a href="index.php?action=inscription" class="signup-link">S'inscrire</a>
        </p>
        ...
        <form class="login-form" action="index.php?action=connexion" method="POST">
